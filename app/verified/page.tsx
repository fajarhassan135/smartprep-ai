  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: bg, fontFamily: "'DM Sans', sans-serif", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ textAlign: "center", maxWidth: 440 }}>
        ...
        {state === "verified" && (
          <>
            <p style={{ fontSize: 11, fontWeight: 600, letterSpacing: "0.12em", textTransform: "uppercase", color: C.orange, marginBottom: 12 }}>Email confirmed</p>
            <h1 style={{ fontSize: "clamp(24px, 5.5vw, 30px)", fontWeight: 600, color: text, marginBottom: 14, letterSpacing: "-0.03em" }}>You&apos;re all set</h1>
            ...
            <a href="/dashboard" style={{ display: "inline-block", padding: "13px 30px", backgroundColor: C.orange, color: "#fff", borderRadius: 12, fontSize: 14, fontWeight: 600, textDecoration: "none" }}>
              Go to dashboard →
            </a>
          </>
        )}
        ...
        {state === "failed" && (
          <>
            <h1 style={{ fontSize: 26, fontWeight: 600, color: text, marginBottom: 12, letterSpacing: "-0.03em" }}>We couldn&apos;t confirm that link</h1>
            <p style={{ fontSize: 14, color: sub, lineHeight: 1.7, marginBottom: 28 }}>{message}</p>
            <a href="/verify-email" style={{ display: "inline-block", padding: "13px 30px", backgroundColor: C.orange, color: "#fff", borderRadius: 12, fontSize: 14, fontWeight: 600, textDecoration: "none" }}>
              Send a new link
            </a>
          </>
        )}
